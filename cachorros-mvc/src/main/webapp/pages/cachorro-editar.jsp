			...
			<div class="col-lg-12">
				<div class="well">
					...
					<form:form modelAttribute="cachorroModel"
						action="${contextPath}/cachorro/${cachorroModel.id}" method="put">
						...
						<div class="form-group">
							...
							<form:input type="number" path="idade" id="idade"
								class="form-control" step="0.1" min="0" maxlength="4" size="15" />
							<font color="red"><form:errors path="idade" /></font><br />
						</div>

						<div class="form-group">
							<label class="control-label" for="descricao">Descrição:</label>
							<form:input type="textbox" path="descricao" id="descricao"
								class="form-control" maxlength="200" size="50" />
